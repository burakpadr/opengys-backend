package com.padr.gys.infra.inbound.realestate.categorization.adapter;
...
import com.padr.gys.infra.inbound.realestate.categorization.model.request.UpdateCategoryRequest;
import com.padr.gys.infra.inbound.realestate.categorization.model.response.CategorizationResponse;
import com.padr.gys.infra.inbound.realestate.categorization.usecase.CreateCategoryAndSubCategoryUseCase;
import com.padr.gys.infra.inbound.realestate.categorization.usecase.DeleteCategoryUseCase;
import com.padr.gys.infra.inbound.realestate.categorization.usecase.FindCategoriesUseCase;
import com.padr.gys.infra.inbound.realestate.categorization.usecase.FindSubCategoriesUseCase;
import com.padr.gys.infra.inbound.realestate.categorization.usecase.UpdateCategoryAndSubCategoryUseCase;
