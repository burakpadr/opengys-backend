package com.padr.gys.infra.inbound.status.adapter;
...
import com.padr.gys.infra.inbound.status.model.response.SubStatusResponse;
import com.padr.gys.infra.inbound.status.usecase.FindStatusUseCase;
import com.padr.gys.infra.inbound.status.usecase.FindSubStatusUseCase;
