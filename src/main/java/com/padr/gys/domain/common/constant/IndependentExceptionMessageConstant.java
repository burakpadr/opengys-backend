...
public class IndependentExceptionMessageConstant {
    ...
    public static final String COULD_NOT_BE_DELETED_FILE_OR_FOLDER = "Dosya/Klasör silinemedi!";
    public static final String FILE_CANNOT_BE_EMPTY = "Dosya içeriği boş olamaz.";
    public static final String UNSUPPORTED_FILE_TYPE = "Bu dosya tipi desteklenmemektedir.";
}
